...
final class ViewModel: ObservableObject {
    ...
    func generateText(prompt:String) async -> String? {
        ...
        do {
            let params  = CompletionParameters(model: "text-davinci-001", prompt: [prompt], maxTokens: 20, temperature: 0.98)
    ...
    var body: some View {
            ...
            NavigationView {
                    ...
                    VStack {
                        ...
                        Spacer()
                        TextField("Type sentence prompt here...", text: $userInput).padding(20).textFieldStyle(.roundedBorder)
